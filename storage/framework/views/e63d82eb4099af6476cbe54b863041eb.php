...
<body class="bg-gray-100 font-sans antialiased">
    ...
    <div class="container mx-auto p-6 max-w-5xl">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="<?php echo e(route('kasir.rekam_medis')); ?>" class="text-sm bg-blue-600 hover:bg-blue-700 text-white px-3 py-2 rounded transition font-medium">
                + Tambah Pasien Baru
            </a>
        </div>
                ...
                <select id="kasir_patient_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm p-2 bg-gray-50 border">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $patients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $patient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <option value="<?php echo e($patient->id); ?>">
                            ...
                            (Alergi: <?php echo e(count($patient->allergies ?? []) ? implode(', ', $patient->allergies) : '-'); ?>,
                            Kondisi: <?php echo e(count($patient->medical_conditions ?? []) ? implode(', ', $patient->medical_conditions) : '-'); ?>)
                        </option>
                ...
                <div class="md:col-span-2">
                    ...
                    <select id="kasir_medicine_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm p-2 bg-white border">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $medicines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $medicine): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            ...
                            <option value="<?php echo e($medicine->id_obat ?? $medicine->id); ?>" data-price="<?php echo e($medicine->harga_jual ?? 0); ?>">
                                <?php echo e($medicine->nama_obat ?? $medicine->name); ?> (<?php echo e($medicine->category); ?> - <?php echo e($medicine->chemical_group); ?>) - Rp <?php echo e(number_format($medicine->harga_jual ?? 0, 0, ',', '.')); ?>
   ...
   <script>
        ...
        function prosesTambahObat() {
            ...
            fetch("<?php echo e(route('sales.check_safety')); ?>", {
                method: 'POST',
                headers: {
...
</html><?php /**PATH C:\laragon\www\apotek final\resources\views/kasir/pos.blade.php ENDPATH**/ ?>